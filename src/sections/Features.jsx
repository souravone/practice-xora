    ...
    <section>
      <Element name="features">
        <div className="container">
          <div className="relative flex md:flex-wrap flex-nowrap border-b-2 border-s3 rounded-7xl md:overflow-hidden max-md:flex-col feature-after md:g7 max-md:border-none max-md:rounded-none max-md:gap-3">
            {features.map(
            ...
            <ul className="relative flex justify-around flex-grow px-[5%] border-b-2 border-s3 rounded-7xl max-md:hidden">
              ...
              {details.map(({ id, icon, title }) => (
                <li key={id} className="relative pt-16 px-4 pb-14">
                  ...
                  <div
                   ...
                   border-2 border-s2 rounded-full shadow-500 hover:border-s4 transition-all duration-500"
                  >
                    <img
                      src={icon}
                      alt={title}
